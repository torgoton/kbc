...
#                         unapproved_users GET    /users/unapproved(.:format)                                                                       users#unapproved
#                                    users POST   /users(.:format)                                                                                  users#create
#                                 new_user GET    /users/new(.:format)                                                                              users#new
#                                     user GET    /users/:id(.:format)                                                                              users#show
#                                join_game POST   /games/:id/join(.:format)                                                                         games#join
#                              action_game POST   /games/:id/action(.:format)                                                                       games#action
#                            end_turn_game POST   /games/:id/end_turn(.:format)                                                                     games#end_turn
