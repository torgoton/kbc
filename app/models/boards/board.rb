module Boards
  class Board
    ...
    TILE_CLASSES = {
      ...
      "LighthouseTile"       => Tiles::LighthouseTile,
      "ForestersLodgeTile"   => Tiles::ForestersLodgeTile,
      "BarracksTile"         => Tiles::BarracksTile,
      "CrossroadsTile"       => Tiles::CrossroadsTile,
      "CityHallTile"         => Tiles::CityHallTile,
      "FortTile"             => Tiles::FortTile,
      "MonasteryTile"        => Tiles::MonasteryTile,
      "WagonTile"            => Tiles::WagonTile,
